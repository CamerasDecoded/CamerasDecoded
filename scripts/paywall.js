...
(function () {
  ...
  var CSS = [
    ...
    '.pw-sheet.pw-bleed .pw-plan{padding:7px 4px 6px;background:rgba(0,0,0,.55);}',
    '.pw-sheet.pw-bleed .pw-plan.pw-sel{padding:6px 3px 5px;}',
    '.pw-sheet.pw-bleed .pw-plan .pw-pname{font-size:9px;letter-spacing:.14em;}',
    '.pw-sheet.pw-bleed .pw-plan .pw-pprice{font-size:17px;margin-top:3px;}',
    '.pw-sheet.pw-bleed .pw-plan .pw-pper{font-size:9px;}',
    '.pw-sheet.pw-bleed .pw-plan .pw-save{top:-9px;font-size:9px;padding:3px 8px;}',
    '.pw-sheet.pw-bleed .pw-go{margin-top:8px;height:46px;font-size:14px;}',
    '.pw-sheet.pw-bleed .pw-foot{margin-top:6px;padding-top:6px;font-size:12px;}',
