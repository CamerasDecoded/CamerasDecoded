...
(function () {
  ...
  var CSS = [
    ...
    '.pw-sheet.pw-bleed .pw-founding{margin:0 0 8px;padding:7px 10px;font-size:11px;line-height:1.45;}',
    '.pw-sheet.pw-bleed .pw-pnote{display:none;}',
    '.pw-sheet.pw-bleed .pw-plans{margin:0 0 4px;gap:8px;}',
    '.pw-sheet.pw-bleed .pw-plan{padding:10px 6px 8px;background:rgba(0,0,0,.55);}',
    '.pw-sheet.pw-bleed .pw-plan.pw-sel{padding:9px 5px 7px;}',
    '.pw-sheet.pw-bleed .pw-plan .pw-pname{font-size:10px;}',
    '.pw-sheet.pw-bleed .pw-plan .pw-pprice{font-size:19px;}',
    '.pw-sheet.pw-bleed .pw-plan .pw-pper{font-size:10px;}',
    '.pw-sheet.pw-bleed .pw-go{margin-top:8px;height:52px;font-size:14px;}',
    '.pw-sheet.pw-bleed .pw-cancel{margin:8px 0 0;font-size:11px;color:rgba(255,255,255,.6);}',
    '.pw-sheet.pw-bleed .pw-foot{margin-top:8px;padding-top:10px;}',
